...
public class DouglasFirTreeFeature extends NCTreeFeature<EvergreenTreeConfiguration> {
    public DouglasFirTreeFeature(Codec<EvergreenTreeConfiguration> codec) {
        super(codec);
    }
    ...
    protected boolean doPlace(@NotNull WorldGenLevel world, RandomSource random, @NotNull BlockPos startPos, BiConsumer<BlockPos, BlockState> roots, BiConsumer<BlockPos, BlockState> logs, FoliagePlacer.FoliageSetter leaves, TreeConfiguration configBase) {
        ...
        int baseHeight = GeneratorUtil.nextIntBetween(random, (int) (height * 0.25F), (int) (height * 0.40F));
