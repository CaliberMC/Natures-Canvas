package com.calibermc.naturescanvas.world.feature.configs;
...
public class EvergreenTreeConfiguration extends NCTreeConfiguration
{
    public static final Codec<EvergreenTreeConfiguration> CODEC = RecordCodecBuilder.create((builder) -> {
        ...
        ).apply(builder, EvergreenTreeConfiguration::new);
    });
    ...
    public static class Builder extends NCTreeConfiguration.Builder<Builder>
    {
