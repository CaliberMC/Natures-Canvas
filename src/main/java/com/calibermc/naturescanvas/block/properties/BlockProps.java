...
//    HALF_TIMBERED(BlockBehaviour.Properties.of().strength(2.0f, 3.0F).sound(SoundType.WOOD).requiresCorrectToolForDrops()),
    ...
    TREE_LEAVES(BlockBehaviour.Properties.copy(Blocks.OAK_LEAVES)),
    TREE_LOG(BlockBehaviour.Properties.copy(Blocks.OAK_LOG)),
    TREE_SAPLING(BlockBehaviour.Properties.copy(Blocks.OAK_SAPLING)),
