package com.calibermc.naturescanvas.client.inventory.recipebook;
...
public class AlloyingRecipeBookComponent extends RecipeBookComponent {
   private static final Component FILTER_NAME = Component.translatable("naturescanvas.gui.recipebook.toggleRecipes.alloying");
