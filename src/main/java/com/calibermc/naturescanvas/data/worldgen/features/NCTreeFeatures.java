...
public class NCTreeFeatures {
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> pContext) {
        ...
        register(pContext, NCTreeFeatures.PINE_TREE_MEDIUM, NCFeatures.PINE_TREE, createPine(NCBlocks.PINE_WOOD.get()).minHeight(25).maxHeight(45).trunkWidth(2).build());
        register(pContext, NCTreeFeatures.PINE_TREE_LARGE, NCFeatures.PINE_TREE, createPine(NCBlocks.PINE_WOOD.get()).minHeight(35).maxHeight(50).trunkWidth(3).build());
