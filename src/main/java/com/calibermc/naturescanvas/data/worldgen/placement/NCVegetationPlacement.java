...
public class NCVegetationPlacement {
    ...
    public static final ResourceKey<PlacedFeature> TREES_OLD_GROWTH_CEDAR_FOREST = NCPlacementUtils.registerKey("trees_old_growth_cedar_forest");
    public static final ResourceKey<PlacedFeature> TREES_FIR_FOREST = NCPlacementUtils.registerKey("trees_fir_forest");
    public static final ResourceKey<PlacedFeature> TREES_PINE_FOREST = NCPlacementUtils.registerKey("trees_pine_forest");
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> context) {
        ...
        final Holder<ConfiguredFeature<?, ?>> TREES_OLD_GROWTH_CEDAR_FOREST = configuredFeatureGetter.getOrThrow(NCVegetationFeatures.TREES_OLD_GROWTH_CEDAR_FOREST);
        final Holder<ConfiguredFeature<?, ?>> TREES_FIR_FOREST = configuredFeatureGetter.getOrThrow(NCVegetationFeatures.TREES_FIR_FOREST);
        final Holder<ConfiguredFeature<?, ?>> TREES_PINE_FOREST = configuredFeatureGetter.getOrThrow(NCVegetationFeatures.TREES_PINE_FOREST);
        ...
        register(context, NCVegetationPlacement.TREES_CEDAR_FOREST, TREES_CEDAR_FOREST, treePlacement(PlacementUtils.countExtra(15, 0.1F, 1))); // MODIFY FOR OLD GROWTH BIOME
        register(context, NCVegetationPlacement.TREES_OLD_GROWTH_CEDAR_FOREST, TREES_OLD_GROWTH_CEDAR_FOREST, treePlacement(PlacementUtils.countExtra(8, 0.2F, 1))); // MODIFY FOR OLD GROWTH BIOME
        register(context, NCVegetationPlacement.TREES_FIR_FOREST, TREES_FIR_FOREST, treePlacement(PlacementUtils.countExtra(12, 0.2F, 1)));
        register(context, NCVegetationPlacement.TREES_PINE_FOREST, TREES_PINE_FOREST, treePlacement(PlacementUtils.countExtra(12, 0.2F, 1)));
