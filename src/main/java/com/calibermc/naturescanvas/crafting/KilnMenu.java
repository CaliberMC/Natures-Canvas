...
public class KilnMenu extends RecipeBookMenu<Container> {
    ...
    public KilnMenu(int pContainerId, Inventory pPlayerInventory) {
        this(NCMenuTypes.KILN.get(), NCRecipeSerializers.ALLOYING_TYPE.get(), NaturesCanvas.KILN_BOOK_TYPE, pContainerId, pPlayerInventory);
    }

    public KilnMenu(int pContainerId, Inventory pPlayerInventory, Container pFurnaceContainer, ContainerData pFurnaceData) {
        this(NCMenuTypes.KILN.get(), NCRecipeSerializers.ALLOYING_TYPE.get(), NaturesCanvas.KILN_BOOK_TYPE, pContainerId, pPlayerInventory, pFurnaceContainer, pFurnaceData);
    }
