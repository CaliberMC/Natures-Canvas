...
public class NCRecipeBuilder implements RecipeBuilder {
    ...
    public static NCRecipeBuilder alloying(Ingredient pIngredient, Ingredient pSecondIngredient, ItemLike pResult, float pExperience, int pCookingTime) {
        return new NCRecipeBuilder(pResult, pIngredient, pSecondIngredient, pExperience, pCookingTime);
    }

    @Override
    public NCRecipeBuilder unlockedBy(String pCriterionName, CriterionTriggerInstance pCriterionTrigger) {
